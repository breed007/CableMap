...
- **325 built-in device templates** across 27 vendors (Ubiquiti, Fortinet, Palo Alto, Cisco/Meraki, TP-Link Omada, MikroTik, Netgear, Aruba, Synology, QNAP, TrueNAS, APC, CyberPower, Eaton, and more).
